...
const FloatingWhatsApp = () => {
  ...
  const whatsappNumber = "+923303694739";
  const message =
    "Hi! I'm interested in learning more about Digital Metaworx services. Can we schedule a free strategy session?";
  ...
  return (
    <>
      ...
      {/* Chat Widget */}
      <div
        className={`fixed bottom-24 right-6 z-50 bg-white rounded-2xl shadow-2xl border border-gray-100 w-80 transform transition-all duration-300 origin-bottom-right ${
